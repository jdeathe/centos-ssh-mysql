...
The latest CentOS-6 based release can be pulled from the centos-6 Docker tag. It is recommended to select a specific release tag - the convention is `centos-6-1.8.1` or `1.8.1` for the [1.8.1](https://github.com/jdeathe/centos-ssh-mysql/tree/1.8.1) release tag.

### Tags and respective `Dockerfile` links

- `centos-6`, `centos-6-1.8.1`, `1.8.1` [(centos-6/Dockerfile)](https://github.com/jdeathe/centos-ssh-mysql/blob/centos-6/Dockerfile)
...
$ docker run \
  ...
  --privileged \
  --volume /:/media/root \
  jdeathe/centos-ssh-mysql:1.8.1 \
